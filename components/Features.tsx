      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {FEATURES_DATA.map((feature) => (
            <div 
              key={feature.id} 
              className="group p-8 rounded-3xl bg-surface-dark border border-slate-800 hover:border-pink-500/50 transition-all duration-300 hover:shadow-glow cursor-default"
            >
