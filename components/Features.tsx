    ...
    <section id="features" className="py-20 bg-white dark:bg-background-dark relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-base text-primary font-semibold tracking-wide uppercase mb-2">Features</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {FEATURES_DATA.map((feature) => (
            <div 
              key={feature.id} 
              className="group p-8 rounded-3xl bg-slate-50 dark:bg-surface-dark border border-slate-100 dark:border-slate-800 hover:border-primary/50 transition-all duration-300 hover:shadow-glow cursor-default"
            >
